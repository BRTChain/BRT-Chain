...
# Create BRT user
RUN adduser --system --group --disabled-password BRT && \
	mkdir -p /wallet /home/BRT/.bitBRT && \
	chown -R BRT:BRT /home/BRT/.bitBRT && \
	chown -R BRT:BRT /wallet

# Contains the blockchain
VOLUME /home/BRT/.bitBRT
...
ENTRYPOINT ["BRTd", "--p2p-bind-ip=0.0.0.0", "--p2p-bind-port=18080", "--rpc-bind-ip=0.0.0.0", "--rpc-bind-port=18081", "--non-interactive", "--confirm-external-bind"]
